...
<html lang="pt-BR">
  ...
  <head>
    ...
    <title>Oráculo de Elden Ring - Assistente Tarnished</title>
    <style>
      ...
      * {
      ...
      /* --- API KEY SECTION (Seção de Chave API) --- */
      .api-key-section {
        padding: 20px;
        background-color: var(--color-dark-bg);
      ...
      .code-block {
        ...
        color: #0fd651; /* Verde neon para código */
      }
  ...
  <body>
    <div class="container">
      <div class="header">
        <h1>Oráculo da Térvore - Assistente Tarnished</h1>
        <p>Busque sabedoria sobre chefes, itens e segredos de Elden Ring.</p>
        <div class="elden-ring-logo">🛡️</div>
      </div>
      ...
      <div class="chat-container">
        ...
        <div class="chat-box" id="chatBox">
          <div class="message bot-message">
            Bem-vindo, **Tarnished**! Sou o Oráculo da Térvore. Por favor, selecione seu Guia (API) e
            insira a chave rúnica (chave da API) para começarmos. Recomendo usar o Google Gemini, que
            oferece um plano gratuito generoso. Posso ajudar com dúvidas sobre
            chefes, armas, feitiços, locais e todo o *Lore* das Entre Terras!
          </div>
        </div>
    ...
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        ...
        const eldenRingKeywords = [
          "Maculado", "Bênção de Fia", "Mesa Redonda", "Leyndell", "Caelid", "Arquivo de Alberich", "Magia Cintilante", "Estudo de Miriel", "Graça da Térvore", "Bolsa de Talismãs", "Grandes Runas", "Lembrança de Godrick", "Lista de Chefes", "Fragmento de História", "Nível de Vigor", "Barra de Vigor", "É Portador de Fragmento", "Cinzas Espirituais", "Cinzas de Guerra", "Classe de Jogador", "Sintonia de Feitiço", "Viajar para a Graça", "Ponto de Decisão", "Rota Segura/Alternativa", "Exploração de Masmorra", "Guardando um Portão", "Tentativa de Aparo", "Frasco de Estus", "Renascer na Graça", "Lei da Ordem Dourada", "Encantamento/Feitiço", "Espaço de Equipamento", "Mapa da Área", "Ensinamentos da Vontade Maior", "A Fragmentação", "Escrita Rúnica", "Nota de um NPC", "Gritando 'Louvado Seja o Sol'", "Reivindicando a Recompensa", "Passo Rápido", "Arma Encantada", "Colheita de Runas", "Seguindo a Trilha da Graça", "Farmando Runas", "Escolha de Bênção", "Genealogia Semideus", "Linhagem de Marika", "Comunhão Draconiana", "Assassino da Faca Negra", "A História dos Deuses Exteriores", "Relatório de Exploração", "Invocação de Espírito", "Estudando as Estrelas", "A Diretiva da Vontade Maior", "Dois Dedos", "Três Dedos", "A Grande Ponte", "Pergaminho de Encantamento", "Prece Antiga do Dragão", "Lista de Itens Derrubados", "Profundezas da Raiz Profunda", "Ritual da Ordem Dourada", "Chama Frenética", "A Biblioteca Real", "Livro-Razão do Mercador Viajante", "Entre Terras", "Local de Graça", "Poço do Rio Ainsel", "Notas Albinaúricas", "Torre de Ranni", "A Forja dos Gigantes", "O Caminho Oculto", "Dissecação do Feitiço", "Julgamento por Combate", "Duelo até a Morte", "Desafio do Lorde Prístino", "Planta de Marika", "Runa de Reparação", "A Cidade Eterna",
        ];
        ...
        saveApiKeyBtn.addEventListener("click", function () {
          ...
          if (!apiKey) {
            addMessage("Por favor, digite uma Chave Rúnica válida.", "warning");
            return;
          }
          ...
          addMessage(
            ...
            }) salva com sucesso! Agora você pode fazer suas perguntas sobre Elden Ring.`,
            "bot"
          );
          messageInput.focus();
        });
        ...
        async function sendMessage() {
          ...
          // Verificar se a pergunta é sobre Elden Ring
          if (!isEldenRingRelated(message)) {
            addMessage(
              "Por favor, faça apenas perguntas relacionadas a Elden Ring. Este Oráculo é especializado em sabedoria das Entre Terras.",
              "warning"
            );
            messageInput.value = "";
            return;
        ...
        async function processQuestion(question) {
          ...
          try {
            ...
            let errorMessage =
              "Desculpe, ocorreu um erro ao consultar o Oráculo. ";

            if (error.message.includes("402")) {
              errorMessage +=
                "O Guia selecionado requer sacrifícios (pagamento). Por favor, use o Google Gemini que tem um plano gratuito.";
            } else if (error.message.includes("401")) {
              errorMessage +=
                "Chave Rúnica inválida ou não autorizada. Verifique sua chave e tente novamente.";
            } else if (error.message.includes("429")) {
              errorMessage +=
                "Limite de requisições (Fúria) excedido. Tente novamente mais tarde.";
              ...
              contents: [
                {
                  parts: [
                    {
                      text: `Você é um Oráculo, um assistente especializado em Elden Ring. Responda apenas perguntas relacionadas a Elden Ring, incluindo chefes, armas, feitiços, armaduras, encantamentos, locais, itens e lore. Sua personalidade deve ser sábia e ligeiramente mística. Se a pergunta não for sobre Elden Ring, explique educadamente que você só pode ajudar com a sabedoria das Entre Terras.
...
Pergunta do Tarnished: ${question}`,
                ...
                messages: [
                  {
                    role: "system",
                    content:
                      "Você é um Oráculo, um assistente especializado em Elden Ring. Responda apenas perguntas relacionadas a Elden Ring, incluindo chefes, armas, feitiços, armaduras, encantamentos, locais, itens e lore. Sua personalidade deve ser sábia e ligeiramente mística. Se a pergunta não for sobre Elden Ring, explique educadamente que você só pode ajudar com a sabedoria das Entre Terras.",
                  },
                  {
                    role: "user",
                    content: question,
        ...
        function isEldenRingRelated(message) {
          ...
          // 2. Checa termos genéricos de Elden Ring, caso a lista específica não cubra tudo.
          const genericKeywords = ["elden ring", "tarnished", "great rune", "site of grace", "malenia", "radagon", "marika", "ranni", "godrick", "boss", "armadura", "arma", "feitiço", "encantamento", "talismã", "build"];
